...
teams=['Mumbai Indians',
 ...
 'Sunrisers Hyderabad',
 'Delhi Capitals']
city=['Bengaluru', 'Delhi', 'Nagpur', 'Sharjah', 'Kolkata', 'Ahmedabad',
       'Cuttack', 'Abu Dhabi', 'Chandigarh', 'Pune', 'Hyderabad',
       'Jaipur', 'Bangalore', 'Kimberley', 'Durban', 'Chennai',
       'Centurion', 'Mumbai', 'Johannesburg', 'Visakhapatnam', 'Mohali',
       'Indore', 'Cape Town', 'Raipur', 'Dharamsala', 'Bloemfontein',
       'Port Elizabeth', 'East London', 'Ranchi']
